...
public class PlayerPoseControllerJ : MonoBehaviour
{
    ...
    // public KeyCode switchPoseKey = KeyCode.E;   // Tombol untuk ganti pose - Hapus atau biarkan untuk fallback keyboard
    ...
    // Hapus method Update yang lama, karena input akan ditangani oleh JoystickInputHandler
    // void Update()
    // {
